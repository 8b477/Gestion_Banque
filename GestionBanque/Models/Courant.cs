...
namespace GestionBanque.Models
{
    public class Courant
    {
        ...
        {
            get { return _solde; }
            private set { _solde = value; } // private set ici je m'assure que le set est uniquement dispo ici
        }
        ...
        public double LigneDeCredit
        {
            ...
            set
            {
                if (value > 0) // Je conditionne ma LigneDeCredit pour ne pas qu'elle puisse passer sous le zero
                {
